...
以下截图位于 `picture/` 目录，展示了当前 MVP Demo 的主要页面。截图分辨率为 1442 × 932，适合在 1440px 宽度的桌面端场景下演示。

### Dashboard：首页工作台

Dashboard 面向老板每天第一次打开软件的使用场景，集中展示今日收入、到店人数、毛利、试用状态、天气经营影响、今日任务和 AI 今日建议。

<img src="./picture/软件首页.png" alt="校园商家 AI 增长助理 Dashboard 首页" width="100%">

### 内容生成：营销文案工作台

内容生成页采用左侧参数、右侧结果预览、下方历史记录的结构。用户可以选择目标渠道、人群、天气、主推商品/套餐、优惠力度和文案风格，生成可直接复制发送的纯文本内容。

<img src="./picture/内容生成.png" alt="内容生成页面" width="100%">

### 活动策划：促销方案生成

活动策划页围绕客流目标、主推套餐、发布时间和优惠规则生成活动方案。优惠规则构建器支持立减、满减、折扣、固定套餐价、赠品和限时券等配置。

<img src="./picture/活动策划.png" alt="活动策划页面" width="100%">

### 数据分析：经营概览

数据分析页支持按近 7 天、14 天、30 天或自定义时间范围查看收入、成本、毛利、到店人数和核销变化。折线图支持鼠标悬停查看具体日期和数值。

<img src="./picture/数据分析.png" alt="数据分析经营概览页面" width="100%">

### 数据分析：套餐与活动效果

数据分析扩展页展示活动效果对比、套餐表现、AI 复盘建议和每日收支记录，帮助商家判断哪些套餐和优惠真正带来转化。

<img src="./picture/数据分析2.png" alt="数据分析套餐与活动效果页面" width="100%">

### 评论回复：顾客沟通助手

评论回复页支持好评、差评、咨询和催单等场景。差评回复会优先包含致歉、处理方案和私聊引导，适合直接用于公开平台或私域沟通。

<img src="./picture/评论回复.png" alt="评论回复页面" width="100%">
